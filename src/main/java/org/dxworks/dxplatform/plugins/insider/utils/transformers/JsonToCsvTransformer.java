package org.dxworks.dxplatform.plugins.insider.utils.transformers;
...
public class JsonToCsvTransformer {
    ...
    public void transformJsonFileToCsv(String jsonFile, String csvFile) throws IOException {
    ...
    public void addCsvFileToJson(String csvFile, String jsonFile) throws IOException {
        JsonFingerprintParser jsonFingerprintParser = new JsonFingerprintParser();
        List<Technology> jsonTechnologies = jsonFingerprintParser.parseTechnologiesFile(jsonFile);

        JavaLibrariesCsvParser javaLibrariesCsvParser = new JavaLibrariesCsvParser();
        List<Technology> csvTechnologies = javaLibrariesCsvParser.parseTechnologiesFile(csvFile);
...
class LibraryImportInOtherTechnology extends LibraryImport {
    private String otherTechnology;

    LibraryImportInOtherTechnology(String _import, String library, String otherTechnology) {
